...
### Install Ethereum Classic node
    ...
    1. Download Geth from here: https://github.com/ethereumproject/go-ethereum/releases 91
    2. Unzip (unzip) or Untar (tar -xvzf) the archive
    3. chmod +x geth
    4. cp geth /usr/local/bin
    5. source ~/.bashrc (for bash)
    6. geth --cache=2048 --rpc --rpcaddr=127.0.0.1 --rpccorsdomain=* --extra-data="open-classic-pool"
...
[Service]
ExecStart=/usr/local/bin/geth --cache=2048 --rpc --rpcaddr=127.0.0.1 --rpccorsdomain=* --extra-data="open-classic-pool"
User=<your-user-name>
...
If you want to debug the node command
    ...
    $ sudo systemctl status ethereumclassic
...
### Install Ethereum Classic Pool
    ...
    $ git clone https://github.com/ruzmat/open-classic-pool
    $ cd open-classic-pool
    $ make all

If you face open-classic-pool after ls ~/open-classic-pool/build/bin/, the installation has completed.

    $ ls ~/open-classic-pool/build/bin/
...
```javascript
{
  ...
  */
  ...
  "payouts": {
    ...
    // The minimum distribution of mining reward. It is 1 ETC now.
...
[Service]
Type=simple
ExecStart=/home/<your-user-name>/open-classic-pool/build/bin/open-classic-pool /home/<your-user-name>/open-classic-pool/config.json
User=<your-user-name>
...
### Modify configuration file
    ...
    $ nano ~/open-classic-pool/www/config/environment.js

Make some modifications in these settings.

    BrowserTitle: 'Ethereum Classic Mining Pool',
...
The frontend is a single-page Ember.js application that polls the pool API to render miner stats.
    ...
    $ bower install
    $ ./build.sh
    $ cp -R ~/open-classic-pool/www/dist ~/www
