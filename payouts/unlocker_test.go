...
import (
	...
	"github.com/ruzmat/open-classic-pool/rpc"
	"github.com/ruzmat/open-classic-pool/storage"
)
...
func TestCalculateRewards(t *testing.T) {
	blockReward, _ := new(big.Rat).SetString("320000000000000000")
...
func TestChargeFee(t *testing.T) {
	orig, _ := new(big.Rat).SetString("320000000000000000")
	value, _ := new(big.Rat).SetString("320000000000000000")
